...
type MapReduce struct {
  ...
  ReduceStarted int
  //ReduceFinished int
  PhaseFinishChannel chan int
  WorkerAssignmentChannel chan string
...
func InitMapReduce(nmap int, nreduce int,
  ...
  mr.WorkerAvailable = make(map[string]bool)
  mr.MapStarted = 0
  //mr.MapFinished = 0
  mr.ReduceStarted = 0
  //mr.ReduceFinished = 0
  mr.PhaseFinishChannel = make(chan int)
  mr.WorkerAssignmentChannel = make(chan string)
